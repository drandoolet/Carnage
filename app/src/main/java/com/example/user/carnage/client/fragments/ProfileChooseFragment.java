...
import com.example.user.carnage.client.fragments.dialogs.AllocateStatsDialogFragment;
...
public class ProfileChooseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profile2ImgButton.setOnClickListener(view12 -> MainActivity.animateChangeWindow());
